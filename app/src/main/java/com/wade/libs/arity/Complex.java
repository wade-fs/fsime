...
public class Complex {
    ...
    */
    ...
    public final Complex csc() {
        return im == 0 ?
                set(1.0 / MoreMath.sin(re), 0) :
                set(1.0 / (MoreMath.sin(re)*Math.sinh(im)), -1.0 / (MoreMath.cos(re)*Math.cosh(im)));
    }
    ...
    public final Complex csch() {
        return im == 0 ? set(Math.sinh(re), 0) : swap().sin().conjugate();
    }
    ...
    public final Complex sec() {
        return im == 0 ?
                set(1.0 / MoreMath.cos(re), 0) :
                set(1.0 / (MoreMath.cos(re)*Math.cosh(im)), -1.0 / (MoreMath.sin(re)*Math.sinh(im)));
    }
    ...
    public final Complex sech() {
        return im == 0 ? set(1.0 / Math.cosh(re), 0) : swap().sec().conjugate();
    }
    ...
    public final Complex cot() {
        if (im == 0) return set(MoreMath.cot(re), Double.NaN);
        double aa = re + re;
        double bb = im + im;
        double down = MoreMath.cos(aa) + Math.cosh(bb);
        return set(down/MoreMath.sin(aa), down/Math.sinh(bb));
    }
    ...
    public final Complex coth() {
        return im == 0 ? set(1.0/Math.tanh(re), 0) : swap().tanh().swap();
    }

    /** asin(x) = -i*log(sqrt(1-x^2)+ix). */
    public final Complex asin() {
        if (im == 0 && Math.abs(re) <= 1) {
            return set(Math.asin(re)*180.0/Math.PI, 0);
        }
        double saveA = re;
        double saveB = im;
    ...
    public final Complex acos() {
        if (im == 0 && Math.abs(re) <= 1) {
            return set(Math.acos(re)*180.0/Math.PI, 0);
        }
        double saveA = re;
        double saveB = im;
    ...
    public final Complex asec() { if (im == 0) return set(MoreMath.asec(re), 0); else return set(0, 0); }
    public final Complex acsc() { if (im == 0) return set(MoreMath.acsc(re), 0); else return set(0, 0); }
    public final Complex acot() { if (im == 0) return set(MoreMath.acot(re), 0); else return set(0, 0); }
    ...
    public final Complex asech() { return set(0, 0); }
    public final Complex acsch() { return set(0, 0); }
    public final Complex acoth() { return set(0, 0); }
